$(document).ready(function(){
  ...
  $('.overlay-button').click(function(){
	...
	$('.refresh-button').click(function(ev){
		...
		var loader = '<div id="refresh-overlay" class="ui-front loader ui-widget-overlay ' + loaderTheme + ' opacity-' + loaderOpacity + '"><img src="/frontend/assets/images/spinner/loader-' + loaderStyle + '.gif" alt="" /></div>';
