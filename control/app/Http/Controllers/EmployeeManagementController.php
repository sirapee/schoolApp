...
class EmployeeManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.employees-mgmt.index', ['employees' => $employees]);
    }
    ...
    public function create()
    {
        ...
        return view('backend.employees-mgmt.create', ['cities' => $cities, 'states' => $states, 'countries' => $countries,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('backend.employee-management');
    }
    ...
    public function edit($id)
    {
        ...
        $departments = Department::all();
        $divisions = Division::all();
        return view('backend.employees-mgmt.edit', ['employee' => $employee, 'cities' => $cities, 'states' => $states, 'countries' => $countries,
        'departments' => $departments, 'divisions' => $divisions]);
    }
    ...
    public function search(Request $request) {
        ...
        return view('backend.employees-mgmt.index', ['employees' => $employees, 'searchingVals' => $constraints]);
    }
