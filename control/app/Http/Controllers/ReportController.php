...
class ReportController extends Controller
{
    ...
    public function index() {
        ...
        return view('backend/system-mgmt/report/index', ['employees' => $employees, 'searchingVals' => $constraints]);
    }

    public function exportExcel(Request $request) {
        $this->prepareExportingData($request)->export('xlsx');
        redirect()->intended('backend/system-management/report');
    }
    ...
    public function exportPDF(Request $request) {
        ...
        $pdf = PDF::loadView('backend/system-mgmt/report/pdf', ['employees' => $employees, 'searchingVals' => $constraints]);
