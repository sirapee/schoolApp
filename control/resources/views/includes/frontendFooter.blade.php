<div class="main-footer bg-gradient-4 clearfix">
    <div class="container clearfix">
                ...
                <ul>
                    <li>
                        <div class="post-image">
                            <a href="{{asset('/frontend/assets/image-resources/stock-images/img-10.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                                <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-10.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-body">
                    ...
                    <li>
                        <div class="post-image">
                            <a href="{{asset('/frontend//assets/image-resources/stock-images/img-11.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                                <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-11.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-body">
                            <a class="post-title" href="blog-single.html" title="">
                    ...
                    <li>
                        <div class="post-image">
                            <a href="{{asset('/frontend/assets/image-resources/stock-images/img-12.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                                <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-12.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="post-body">
                            <a class="post-title" href="blog-single.html" title="">
                            ...
                            by <a href="#">Sixteen Hundreds</a> on 16.06.2017
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="row no-gutter">
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-20.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-20.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-19.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-19.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-18.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-18.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-17.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-17.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-16.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-16.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="{{asset('/frontend/assets/image-resources/stock-images/img-15.jpg')}}" class="prettyphoto" rel="prettyPhoto[pp_gal]" title="Blog post title">
                        <img class="img-responsive" src="{{asset('/frontend/assets/image-resources/stock-images/img-15.jpg')}}" alt="">
                    </a>
                </div>
            </div>
    ...
    <div class="footer-pane">
        <div class="container clearfix">
            <div class="logo">&copy; 2017 Caring Heart. All Rights Reserved.</div>
