    ...
    <nav class="navbar navbar-static-top">
        <div class="container-fluid m-0">
            <a class="navbar-brand float-left" href="{{url('/')}}">
                <h4><img src="{{asset('img/logo1.ico')}}" class="admin_img" alt="logo"> Caring Heart Member</h4>
            </a>
            <div class="menu">
                ...
                <div class="btn-group">
                    <div class="user-settings no-bg">
                        <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                            <img src="{{asset('uploads/'.Sentinel::getUser()->profile_image)}}" class="admin_img2 img-thumbnail rounded-circle avatar-img"
                                 alt="avatar"> <strong>{{Sentinel::getUser()->first_name}}</strong>
                            <span class="fa fa-sort-down white_bg"></span>
                        </button>
                        <div class="dropdown-menu Caring Heart_admin">
                            ...
                            <form method="post" action="{{ url('/userLogout') }}" id="logout-form">
                                {{csrf_field()}}
                                <a class="dropdown-item" href="#" onclick="document.getElementById('logout-form').submit()"><i class="fa fa-sign-out"></i>
                                    Log Out</a>
                            </form>
                        </div>
                    </div>
