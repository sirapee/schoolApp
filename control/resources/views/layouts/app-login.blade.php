...
<html>
  <head>
    ...
    <title>School Application</title><link rel="shortcut icon" href="{{asset('images/favicon.ico')}}" />
    ...
    <link href="{{asset('/fancyBox/source/jquery.fancybox.css')}}" rel="stylesheet" type="text/css"></link>
