...
@section('main_container')
    ...
    <div class="owl-slider-2 slider-wrapper">
        ...
        <div class="poly-bg-1 hero-box font-inverse hero-box-smaller">
            <div class="container clearfix">
                <div class="col-md-4 img-holder wow fadeInUp">
                    <img src="{{asset('/frontend/assets/image-resources/objects/1.png')}}" alt="">
                </div>
                <div class="col-md-8">
                    <h1 class="hero-heading wow fadeInDown" data-wow-duration="0.6s">Caring Hearts</h1>
                    <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s">We spread the gospel of God’s love by giving aid and assistance to the weak, invalid, underprivileged, orphaned and aged in our Society...</p>
        ...
        <div class="hero-box full-bg-4 font-inverse">
            <div class="container">
                <div class="col-md-4 img-holder wow fadeInUp">
                    <img src="{{asset('/frontend/assets/image-resources/objects/2.png')}}" alt="">
                </div>
                ...
                <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s" style="visibility: visible; -webkit-animation: 0.9s 0.2s;">
                    We care for the poor and aged through direct and personal contact, showing and giving love through hands- on service...</p>
            </div>
        ...
        <div class="hero-box full-bg-9 font-inverse" data-top-bottom="background-position: 50% 0px;" data-bottom-top="background-position: 50% -600px;">
            <div class="container">
                ...
                <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s">
                    We Visit Orphanages, Hospitals and Care homes to help and assist the care givers in feeding, washing, bathing, cleaning and attending to their general needs...</p>
        ...
        <div class="hero-box poly-bg-2 hero-box-smaller font-inverse">
            <div class="container">
                ...
                <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s" style="visibility: visible; -webkit-animation: 0.9s 0.2s;">We maintain relationship with individuals under our care through phone calls, one-on-one visitation, hospital visitation and organizing special events, recreative/fun trips or outings thereby showing them love and putting smiles to their face..</p>
        ...
        <div class="poly-bg-4 hero-box hero-right font-inverse hero-box-smaller">
            <div class="container clearfix">
                <div class="col-md-7">
                    ...
                    <p class="hero-text wow bounceInUp mrg25B" data-wow-duration="0.9s" data-wow-delay="0.2s">
                        Caring Heart provides spiritual and emotional support through counselling and prayer, or referrals to   other Counselors, Churches or Pastors..</p>
                    <!--  <a href="#" class="btn-outline-inverse hero-btn wow fadeInUp" data-wow-delay="0.4s" title="Purchase Button">Find out more</a> -->
                </div>
                <div class="col-md-5 img-holder wow fadeInUp">
                    <img src="{{asset('/frontend/assets/image-resources/objects/3.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
